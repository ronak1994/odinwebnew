   ...
   <div class="js-smooth-scroll bg-dark-1" id="page-wrapper" data-barba="container">
        <main class="page-wrapper__content">
          ...
          <section class="section section-masthead section-fullheight text-center bg-dark-1" data-arts-os-animation="data-arts-os-animation" data-arts-theme-text="light" data-background-color="var(--color-dark-1)">
            <div class="section-masthead__inner section-fullheight__inner container-fluid">
              <header class="row section-masthead__header justify-content-center">
                <div class="col">
                <div class="w-100">
                    <div class="section-masthead__subheading h3 mt-0-5 split-text js-split-text" data-split-text-type="lines,words" data-split-text-set="words"><span>Escape Meidocrity & Welcome the next generation of</span></div>
                  </div>
                
                <div class="section-masthead__heading split-text heading-box-h1 js-split-text overflow" data-split-text-type="lines,chars" data-split-text-set="chars">
                    <h1 class="xl mt-0 mb-0 check"></h1>
                  </div>
                  <div class="w-100">
                    <div class="section-masthead__wrapper-button mt-xsmall">
                      <a class="button button_bordered button_white" data-hover="Explore Now" href="" target="_blank"><span class="button__label-hover">Why Choose Us?</span></a>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="circle-button js-circle-button" data-arts-os-animation="true">
                    ...
                    <div class="circle-button__outer">
                      <div class="circle-button__wrapper-label">
                        <div class="circle-button__label small-caps">Scroll To Get Started</div>
                      </div>
                    </div>
                    <!-- - curved label -->
                    <!-- geometry wrapper -->
            ...
            <div class="section-image section-masthead__background section-masthead__background_fullscreen">
              <div class="section-image__wrapper js-transition-img" data-arts-parallax="data-arts-parallax" data-arts-parallax-factor="0.15">
                ...
                <video id="videoId" muted="" autoplay="" loop="" preload="auto" width="100%" height="100%">
                  <source src="https://theodin.in/img/main3.mp4" type="video/mp4">
                </video>
                </div>
              </div>
              <!-- overlay-->
          ...
          <!-- - section MASTHEAD -->
           ...
           <!-- section DEMO #1 -->
           <div class="section bg-dark-1 pt-medium pb-small overflow">
                ...
                <div class="row align-items-center">
                  <div class="col-lg-6">
                    <div class="section-demo__content">
                      <section class="section section-content clearfix" data-arts-os-animation="data-arts-os-animation" data-arts-theme-text="light">
                        <div class="section-content__inner">
                          ...
                          <div class="section-content__heading split-text js-split-text" data-split-text-type="lines,words" data-split-text-set="words">
                            <h3>We Know you love nothing less than excellence!</h3>
                          </div>
                          <div class="w-100"></div>
                          <div class="section-content__text split-text js-split-text mt-1" data-split-text-type="lines" data-split-text-set="lines">
                            <p>Generic solutions put your business into a competition with mediocre brands.</p>
                             
                            <p>Your business needs more than that to put you ahead. </p>
                           <p>
                            You can never realise the true potential of your business with one-size-fits all solutions.
                          </p>
                          </div>
                        </div>
                      </section>
                     
                      <div class="mt-small d-lg-none">
                        <a class="button button_bordered button_black" data-hover="Explore Our Philosophy" href="project-details-1-fullscreen-center.html" target="_blank">
                          <span class="button__label-hover">Explore Our Philosophy</span>
                        </a>
                      </div>
                    </div>
                  </div>
            ...
            <div class="section-demo__bg section-demo__bg_right bg-dark-1 d-none d-lg-block"></div>
          ...
          <!-- - section DEMO #1 -->
                ...
                <div class="container">
                  <div class="row justify-content-center">
                    <div class="col-12 col-lg-10">
                      ...
                      <h1>Fullfill the true potential of your business</h1>
                      <p>We custom curate the right solutions for your business. we are right at the intersection of technology, art and marketing.</p>
                      </div>
                    </div>
                    <div class="col-12 col-lg-10">
                      <div class="section-content__button">
                        <a class="button button_solid button_black" data-hover="Download Now" href="https://themeforest.net/item/rhye-ajax-portfolio-html5-template/26306579?aid=artemsemkin&aso=demo&aca=cta" target="_blank">
                          <span class="button__label-hover">Download Now</span>
                        </a>
                      </div>
                    </div>
                  </div>
           ...
           <!-- - section DEMO #2 -->
           <div class="bg-light-2 text-center section-scroll" data-arts-theme-text="dark" data-arts-scroll-theme-text="light" data-arts-default-theme="bg-white" data-arts-scroll-theme="bg-dark-1" data-arts-scroll-trigger-hook="0.0" data-arts-scroll-offset="-100">
            <!-- section CONTENT #4 -->
            <section class="section section-content clearfix pt-small pb-small text-center" data-arts-os-animation="data-arts-os-animation">
              <div class="section-content__inner">
                <div class="w-100"></div>
                <div class="section__headline mb-1 mb-md-2 mx-auto"></div>
                <div class="w-100"></div>
                <div class="section-content__heading split-text js-split-text" data-split-text-type="lines,words" data-split-text-set="words">
                  <h2>Best Companies Around the Globe Hire Us For</h2>
                </div>
              </div>
            </section>
            <!-- - section CONTENT #4 -->
                    ...
                    <div class="section-grid__item">
                      <div class="figure-icon">
                        ...
                        <div class="figure-icon__header">
                          <div class="figure-feature__heading paragraph strong mt-1 mb-0">Corporate Websites</div>
                        </div>
                        <!-- - header -->
                      </div>
                    </div>
                  ...
                  <div class="col-lg-3 col-sm-6 col-gutters">
                    <div class="section-grid__item">
                      <div class="figure-icon">
                        ...
                        <!-- header -->
                        <div class="figure-icon__header">
                          <div class="figure-feature__heading paragraph strong mt-1 mb-0">E-commerce Websites</div>
                        </div>
                        <!-- - header -->
                      </div>
                    </div>
                  ...
                  <div class="col-lg-3 col-sm-6 col-gutters">
                    <div class="section-grid__item">
                      <div class="figure-icon">
                        ...
                        <!-- header -->
                        <div class="figure-icon__header">
                          <div class="figure-feature__heading paragraph strong mt-1 mb-0">Mobile Applications</div>
                        </div>
                        <!-- - header -->
                      </div>
                    </div>
                  ...
                  <div class="col-lg-3 col-sm-6 col-gutters">
                    <div class="section-grid__item">
                      <div class="figure-icon">
                        ...
                        <!-- header -->
                        <div class="figure-icon__header">
                          <div class="figure-feature__heading paragraph strong mt-1 mb-0">Social Media Managment</div>
                        </div>
                        <!-- - header -->
                      </div>
                    </div>
                  ...
                  <div class="col-lg-3 col-sm-6 col-gutters">
                    <div class="section-grid__item">
                      <div class="figure-icon">
                        ...
                        <!-- header -->
                        <div class="figure-icon__header">
                          <div class="figure-feature__heading paragraph strong mt-1 mb-0">Custom CRMs</div>
                        </div>
                        <!-- - header -->
                      </div>
                    </div>
                  ...
                  <div class="col-lg-3 col-sm-6 col-gutters">
                    <div class="section-grid__item">
                      <div class="figure-icon">
                        ...
                        <!-- header -->
                        <div class="figure-icon__header">
                          <div class="figure-feature__heading paragraph strong mt-1 mb-0">Custom Softwares</div>
                        </div>
                        <!-- - header -->
                      </div>
                    </div>
                  ...
                  <div class="col-lg-3 col-sm-6 col-gutters">
                    <div class="section-grid__item">
                      <div class="figure-icon">
                        ...
                        <!-- header -->
                        <div class="figure-icon__header">
                          <div class="figure-feature__heading paragraph strong mt-1 mb-0">Product Development</div>
                        </div>
                        <!-- - header -->
                      </div>
                    </div>
                  ...
                  <div class="col-lg-3 col-sm-6 col-gutters">
                    <div class="section-grid__item">
                      <div class="figure-icon">
                        ...
                        <!-- header -->
                        <div class="figure-icon__header">
                          <div class="figure-feature__heading paragraph strong mt-1 mb-0">Brand Identity Design</div>
                        </div>
                        <!-- - header -->
                      </div>
                    </div>
                  ...
                  <div class="col-lg-3 col-sm-6 col-gutters">
                    <div class="section-grid__item">
                      <div class="figure-icon">
                        ...
                        <!-- header -->
                        <div class="figure-icon__header">
                          <div class="figure-feature__heading paragraph strong mt-1 mb-0">Performance Marketing</div>
                        </div>
                        <!-- - header -->
                      </div>
                    </div>
                  ...
                  <div class="col-lg-3 col-sm-6 col-gutters">
                    <div class="section-grid__item">
                      <div class="figure-icon">
                        ...
                        <!-- header -->
                        <div class="figure-icon__header">
                          <div class="figure-feature__heading paragraph strong mt-1 mb-0">Website Maintaince/Updates</div>
                        </div>
                        <!-- - header -->
                      </div>
                    </div>
                  ...
                  <div class="col-lg-3 col-sm-6 col-gutters">
                    <div class="section-grid__item">
                      <div class="figure-icon">
                        ...
                        <!-- header -->
                        <div class="figure-icon__header">
                          <div class="figure-feature__heading paragraph strong mt-1 mb-0">Prototype/ MVP Development</div>
                        </div>
                        <!-- - header -->
                      </div>
                    </div>
            ...
            <!-- section CONTENT #1 -->
            <section class="section section-content clearfix bg-dark-3 pt-small pb-small text-center" data-arts-os-animation="data-arts-os-animation" data-arts-theme-text="light" id="demo">
            <div class="section-content__inner">
              <div class="w-100"></div>
              <div class="section__headline mb-1 mb-md-2 mx-auto"></div>
              <div class="w-100"></div>
          ...
          <section class="section section-grid section-content overflow pb-medium bg-dark-3" data-arts-theme-text="light" data-arts-os-animation="data-arts-os-animation" data-grid-columns="3" data-grid-columns-tablet="2" data-grid-columns-mobile="1">
          ...
          <!-- section CONTENT #3 -->
          <section class="section section-content clearfix bg-light-1 pt-medium pb-small text-center" data-arts-os-animation="data-arts-os-animation">
            <div class="section-content__inner">
              <div class="w-100"></div>
              <div class="section__headline mb-1 mb-md-2 mx-auto"></div>
              <div class="w-100"></div>
          ...
          <section class="section section-grid section-content overflow pb-medium bg-light-1" data-arts-os-animation="data-arts-os-animation" data-grid-columns="4" data-grid-columns-tablet="2" data-grid-columns-mobile="1">
            <div class="container-fluid">
              <div class="grid grid_fluid-3 js-grid">
          ...
          <div class="section bg-light-2">
            ...
            <div class="section-demo__bg section-demo__bg_wide section-demo__bg_left bg-light-2" data-arts-parallax data-arts-parallax-factor="0.3">
              <div>
